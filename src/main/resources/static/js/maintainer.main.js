 ...
 * - Legge XML: GET /api/distributors/state.xml
 * - Refill: POST /api/maintainer/distributors/refill (code)
 * - Status: POST /api/maintainer/distributors/status (code, status=attivo|manutenzione|disattivo)
 * - Me: GET /api/maintainer/me
 */
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadXml() {
        // riuso fetchXML del tuo apiHelpers
    ...
    function renderDistributors(xmlDoc) {
        ...
        list.innerHTML = nodes.map(d => {
            ...
            const stato = getText(d, "stato_operativo");
                    ...
                    <div style="display:flex; justify-content:space-between; gap:10px; flex-wrap:wrap;">
                        ...
                        <div style="min-width:280px;">
                            ...
                            <div style="display:flex; gap:8px; flex-wrap:wrap; margin-top:10px;">
                                ...
                                <button class="btn btn-secondario" data-action="status" data-status="disattivo" data-code="${escapeAttr(code)}">Disattivo</button>
                            </div>
                        </div>
                    </div>
